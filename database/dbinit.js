...
schTable = "CREATE TABLE Schedule(schid INTEGER PRIMARY KEY AUTOINCREMENT, startDate DATE, lessonTime DATETIME, lessonLength INTEGER, sid INTEGER references SRecord(sid));";
