...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, jwtInterceptorProvider, $httpProvider) {
    ...
    $stateProvider
        ...
        // .state('teacher-dashboard.viewStudentRecord/:sid/:firstName/:lastName/:instrument/:email/:phone/:address/:birthday/:startDate/:numberOfLessons/:lessonTime/:lessonLength/:generalNotes/:lessonNotes', {
        //     url: "/viewStudentRecord/:sid/:firstName/:lastName/:instrument/:email/:phone/:address/:birthday/:startDate/:numberOfLessons/:lessonTime/:lessonLength/:generalNotes/:lessonNotes",
        //     templateUrl: "views/studentRecordPageView.html",
