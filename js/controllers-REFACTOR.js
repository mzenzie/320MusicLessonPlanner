 ...
 */
.controller('teacherController', function teacherController($scope, $resource, $stateParams, $state, $modal, $log) {
 ...
 */
.controller('TodayViewController', function TodayViewController($scope, $resource, $modal, $stateParams, $state, $log, $q) {
 ...
 */
.controller('ModalDeleteStudentCtrl', function ModalDeleteStudentCtrl($scope, $modalInstance) {
 ...
 */
.controller('StudentRecordCtrl', function StudentRecordCtrl($scope, $stateParams, getStudentByID, $log) {
    ...
    $scope.student = getStudentByID(sid);
 ...
 */
.controller('StudentRecordCreationCrtl', function StudentRecordCreationCrtl($scope, $resource, $state, $log) {
    var StudentRecord = $resource('/api/studentRecord/');
...
.controller('loginCtrl', function loginCtrl($state, $stateParams, $scope, $resource, $http, store, jwtHelper, getTeacherByID, $log) {
    ...
    $scope.signin = function() {
        $http.post('/api/signin', {
            ...
            .success(function(data, status, header, config) {
                ...
                $scope.teacherProfile = getTeacherByID(decodedToken.id);

                $log.warn('Result of TeacherRecord.get (firstName): ' + result.firstName);
...
.controller('lessonNoteController', function lessonNoteController($scope, $resource) {
 ...
 */
.factory('getStudentByID', function($resource, sid) {
    var studentRecords = $resource('/api/studentRecord/');
 ...
 *      Factory that passes student data from one controller to another
 */
.factory('getTeacherByID', function($resource, tid) {
    var teacherRecords = $resource('/api/teacher/:id');
    var teacherProfile = {};
    teacherRecords.get({
        id: tid
    }, function(result) {
        teacherProfile = result;
        $log.warn('Result of teacherRecords.get (firstName): ' + result.firstName);
    });
